	...
	public static void main(String[] args) {
		...
		while(true)
		{
			...
			else if(menu==2)
			{
				...
				System.out.println("영화명: "+movie.genre[no-1]);
				System.out.println("영화명: "+movie.actor[no-1]);
				System.out.println("영화명: "+movie.director[no-1]);
				System.out.println("영화명: "+movie.regdate[no-1]);
				System.out.println("영화명: "+movie.grade[no-1]);
